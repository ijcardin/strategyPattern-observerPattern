...
public class ObserverPatternController {
 	public static void main(String []s) {
		...
		ThreeColumnTableObserver ht = new ThreeColumnTableObserver(mydata);
		FiveRowsTableObserver vt = new FiveRowsTableObserver(mydata);
		OneRowObserver hl = new OneRowObserver(mydata);	
		mydata.notifyObserver();
		...
		ht = new ThreeColumnTableObserver(mydata);
		mydata.notifyObserver();
	}
}
